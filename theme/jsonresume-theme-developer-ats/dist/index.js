...
function Summary({ summary }) {
	...
	return /* @__PURE__ */ jsx("section", {
		...
		children: /* @__PURE__ */ jsx("p", {
			className: "text-[10pt] leading-tight whitespace-pre-line text-ink/80",
				...
				children: [
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("h3", {
							className: "font-mono text-[12pt] font-medium text-ink",
					...
					subtitle && /* @__PURE__ */ jsx("p", {
						className: "mt-0.5 text-[10pt] font-medium text-subaccent",
						children: renderRichText(subtitle)
					}),
					description && /* @__PURE__ */ jsx("p", {
						className: "mt-1 text-[10pt] leading-tight text-ink/80",
		...
		children: /* @__PURE__ */ jsx("div", {
			...
			children: skills.map((skill, index) => /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("h3", {
					...
					className: "flex-1 rounded border-l-2 border-accent bg-surface px-2.5 py-1.5 text-[9pt] font-mono text-muted",
		...
		children: education.map((edu, index) => /* @__PURE__ */ jsx(Entry, {
			...
			children: edu.courses && edu.courses.length > 0 && /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("p", {
					...
					className: "mt-1 text-[8pt] leading-tight text-ink/70",
...
function Languages({ languages = [] }) {
	...
	return /* @__PURE__ */ jsx(Section, {
		title,
		children: /* @__PURE__ */ jsx("p", {
			className: "text-[10pt] leading-tight text-ink/80",
