	...
	return /* @__PURE__ */ jsx(Section, {
		...
		children: education.map((edu, index) => /* @__PURE__ */ jsx(Entry, {
			...
			children: edu.courses && edu.courses.length > 0 && /* @__PURE__ */ jsxs("div", {
				className: "mt-2 print:break-inside-avoid",
				children: [/* @__PURE__ */ jsx("p", {
					className: "text-[8pt] font-semibold uppercase tracking-wide text-subtle",
					children: courseworkLabel
				}), /* @__PURE__ */ jsx("p", {
					className: "mt-1 columns-3 gap-x-5 text-[7.5pt] leading-snug text-ink/70",
					children: edu.courses.map(formatCourseName).join(", ")
				})]
			})
		}, index))
	});
